...
|-------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 4.0.2                                                                         | [![Maven Central](https://img.shields.io/maven-central/v/io.github.sgzachesov/spring-data-jpa-specification-builder/4.0.2.svg)](https://search.maven.org/artifact/io.github.sgzachesov/spring-data-jpa-specification-builder/ "Maven Central") |
